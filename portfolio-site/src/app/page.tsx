export default function Home() {
  return (
    <div className="font-sans min-h-screen p-6 sm:p-10 bg-white text-neutral-900">
      <main className="mx-auto max-w-4xl">
        <header className="flex items-start gap-6 mb-10">
          <div className="shrink-0">
            {/* Place your image at public/headshot.jpg or change the src below */}
            <img
              src="/headshot.jpg"
              alt="Headshot"
          ...
          <div className="mt-3 space-y-4">
            <div>
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-baseline">
                <h3 className="font-medium">IE University (IEU) — Madrid, Spain</h3>
                <span className="text-sm text-neutral-600">Expected: June 2027</span>
              </div>
              <p className="text-sm text-neutral-700">Bachelor of Computer Science and Artificial Intelligence · GPA: 9.4/10 (Ranked 4th with Honors)</p>
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-baseline">
                <h3 className="font-medium">Homeschool — Cambridge International Education System • Kuala Lumpur, Malaysia</h3>
                <span className="text-sm text-neutral-600">Sept 2019 - June 2023</span>
              </div>
              <p className="text-sm text-neutral-700">IGCSE and A Levels · Straight A student and top of class</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="mt-3 space-y-6">
            <div>
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-baseline">
                <h3 className="font-medium">Research Analyst — IEU Student Government, Madrid, Spain</h3>
                <span className="text-sm text-neutral-600">Sep 2024 - Jun 2025</span>
              </div>
              <ul className="list-disc ml-5 mt-1 text-sm text-neutral-700 space-y-1">
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-baseline">
                <h3 className="font-medium">Designer & Junior Developer — Web Development Club, Kuala Lumpur, Malaysia</h3>
                <span className="text-sm text-neutral-600">Jun 2022 - Aug 2023</span>
              </div>
              <ul className="list-disc ml-5 mt-1 text-sm text-neutral-700 space-y-1">
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-baseline">
                <h3 className="font-medium">Cashier & Operations Assistant — 7‑Eleven, Kuala Lumpur, Malaysia</h3>
                <span className="text-sm text-neutral-600">Jun 2019 – Aug 2022</span>
              </div>
              <ul className="list-disc ml-5 mt-1 text-sm text-neutral-700 space-y-1">
        ...
        <footer className="mt-10 pt-6 border-t border-neutral-200 text-xs text-neutral-600 text-center">
